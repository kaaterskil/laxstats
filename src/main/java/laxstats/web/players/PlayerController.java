...
public class PlayerController extends ApplicationController {
	...
	public PlayerController(UserQueryRepository userRepository,
			CommandBus commandBus, PersonQueryRepository personRepository) {
	...
	public String createPlayer(
		...
		final PlayerDTO dto = new PlayerDTO(playerId, person, teamSeason,
	...
	public String updatePlayer(
		...
		final PlayerDTO dto = new PlayerDTO(playerIdentifier, person,
				teamSeason, person.getFullName(), form.getRole(),
				form.getStatus(), form.getJerseyNumber(), form.getPosition(),
				form.isCaptain(), form.getDepth(), form.getHeight(),
				form.getWeight(), now, user);
